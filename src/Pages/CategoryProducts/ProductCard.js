  ...
  return (
    <div className="rounded-md shadow-md sm:w-96 bg-gray-900 text-gray-100">
      <div className="flex items-center justify-between p-3">
        <div className="flex items-center space-x-2">
          <div className="text-left">
            ...
            <p className="block text-xs leading-none mt-2 text-gray-400">
              Post Published: {time}
            </p>
            <span className="inline-block text-xs leading-none text-gray-400">
              Location: {location}
            </span>
            <p className="block text-xs leading-none text-gray-400">
      ...
      <img
        src={photoUrl}
        alt=""
        className="object-fill w-full h-80 dark:bg-gray-500"
      />
      <div className="p-0 py-6">
        ...
        <div className="text-left mx-4">
          <p className=" text-base font-semibold">
            Price: ${price}{" "}
            <span className="ml-4 line-through">${buyPrice}</span>{" "}
          </p>
          ...
          <div className="flex justify-between mt-6 ">
            <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
              ...
              onClick={()=> setProduct(product)}
                ...
                className="btn px-4 py-1 text-sm font-semibold rounded btn-sm btn-secondary text-black hover:btn-error"
              >
                Book Now
              </label>
            </div>
